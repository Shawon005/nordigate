		...
		<!-- Featured One -->
		<section class="featured-one" style="margin-top: -153px !important">
			<div class="auto-container">
    						...
    						<div class="service-block_three-inner">
    							...
    							<div class="service-block_three-overlay">
    								...
    								<span class="service-block_three-icon-two"><img src="{{$service->logo}}"
    										alt="" /></span>
    								<h5 class="service-block_three-heading alternate"><a href="{{route('service-details',$service->slug)}}">{{$service->title}} </a></h5>
    								<a class="service-block_three-learn" href="{{route('service-details',$service->slug)}}">Learn More</a>
    							</div>
    						</div>
    					</div>
    					@endforeach
                                ...
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__client-info">
                                        <div class="testimonial-one__client-img">
                                            <img src="{{$review->image}}"  style="width:50px" class="rounded-circle"  alt="">
                                        </div>
                                        <div class="testimonial-one__client-details">
                                            <h5 class="testimonial-one__client-name">{{$review->name}}</h5>
                                            <p class="testimonial-one__client-title">{{$review->title}}</p>
                                        </div>
                                    </div>
                                    <p class="testimonial-one__text">{{$review->description}}</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                        <a class="tech-box text-center" href="javascript:;">
                            <div class="icon-main"> <img src="{{$technology->image}}" style="height:58px;" alt="">
							</div>
