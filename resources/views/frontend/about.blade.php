					...
					<div class="about-one_content col-lg-6 col-md-12 col-sm-12">
						<div class="about-one_content-inner">
							<div class="sec-title">
								...
								<h2 class="sec-title_heading">{!!$setting->about_title !!}</h2>
								<div class="sec-title_text">{{$setting->about_description}}</div>
							</div>
								...
								<div class="about-tabs tabs-box">
									...
									<div class="tabs-content">
										...
										<div class="tab active-tab" id="prod-mission">
											<div class="content">
												<div class="text">{{$setting->our_mission}}</div>
											</div>
										</div>
										...
										<div class="tab" id="prod-vision">
											<div class="content">
												<div class="text">{{$setting->our_vission}}</div>
											</div>
										</div>
