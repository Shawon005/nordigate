<header class="main-header header-style-two">
			...
			<div class="header-top_two">
				<div class="auto-container">
					<div class="d-flex justify-content-center align-items-center flex-wrap">
						...
						<!-- Info List -->
						<ul class="info-list">
							<li><a href="tel:17787"><span class="icon fa-solid fa-phone fa-fw"></span>17787</a></li>
							<li><a href=""><span class="icon fa-solid fa-envelope fa-fw"></span>info@nordigate.com</a>
							</li>
			...
			<div class="header-upper">
				<div class="auto-container">
					<div class="inner-container d-flex">
						<!-- Logo Box -->
						<div class="logo"><a href="{{route('home')}}"><img src="{{asset('')}}frontend/images/original.png" alt="" title=""></a></div>
										...
										<!-- 	<li class="dropdown"><a href="products.html">Products</a>
										 ...
										 <ul>
											...
											<li class="dropdown"><a>Other</a>
												...
												<ul>
													<li class=""><a href="{{route('industries')}}">Case Studies</a></li>
													<li class=""><a href="{{route('project')}}">Solutions</a></li>
													<li class=""><a href="{{route('product')}}">Careers</a></li>
			...
			<div class="sticky-header">
				<div class="auto-container">
					<div class="d-flex justify-content-between align-items-center">
						<!-- Logo -->
						<div class="logo">
							<a href="index.html" title=""><img src="{{asset('')}}frontend/images/original.png" alt="" title=""></a>
						</div>
			...
			<div class="mobile-menu">
				...
				<nav class="menu-box">
					<div class="nav-logo"><a href="index.html"><img src="{{asset('')}}frontend/images/original.png" alt="" title=""></a></div>
					<!-- Search -->
					<div class="search-box">
						<form method="post" action="{{route('contact')}}">
							<div class="form-group">
