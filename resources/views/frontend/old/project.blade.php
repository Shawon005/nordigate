            ...
            <div class="mixitup-gallery">
                ...
                <div class="filter-list row clearfix">
					...
					<div class="project_one mix all design col-lg-3 col-md-6 col-sm-12">
						<div class="project_one-inner">
							<div class="project_one-image">
								<img src="{{asset('')}}frontend/images/gallery/project-1.jpg" alt="" />
					...
					<div class="project_one mix all cloud col-lg-3 col-md-6 col-sm-12">
						<div class="project_one-inner">
							<div class="project_one-image">
								<img src="{{asset('')}}frontend/images/gallery/project-2.jpg" alt="" />
								<div class="project_one-content">
					...
					<div class="project_one mix all design col-lg-3 col-md-6 col-sm-12">
						<div class="project_one-inner">
							<div class="project_one-image">
								<img src="{{asset('')}}frontend/images/gallery/project-3.jpg" alt="" />
								<div class="project_one-content">
					...
					<div class="project_one mix all cloud web col-lg-3 col-md-6 col-sm-12">
						<div class="project_one-inner">
							<div class="project_one-image">
								<img src="{{asset('')}}frontend/images/gallery/project-4.jpg" alt="" />
								<div class="project_one-content">
					...
					<div class="project_one mix all design col-lg-3 col-md-6 col-sm-12">
						<div class="project_one-inner">
							<div class="project_one-image">
								<img src="{{asset('')}}frontend/images/gallery/project-5.jpg" alt="" />
								<div class="project_one-content">
					...
					<div class="project_one mix all cloud web col-lg-3 col-md-6 col-sm-12">
						<div class="project_one-inner">
							<div class="project_one-image">
								<img src="{{asset('')}}frontend/images/gallery/project-6.jpg" alt="" />
								<div class="project_one-content">
					...
					<div class="project_one mix all design col-lg-3 col-md-6 col-sm-12">
						<div class="project_one-inner">
							<div class="project_one-image">
								<img src="{{asset('')}}frontend/images/gallery/project-7.jpg" alt="" />
								<div class="project_one-content">
					...
					<div class="project_one mix all cloud web col-lg-3 col-md-6 col-sm-12">
						<div class="project_one-inner">
							<div class="project_one-image">
								<img src="{{asset('')}}frontend/images/gallery/project-8.jpg" alt="" />
								<div class="project_one-content">
									<h5 class="project-one_title"><a href="project-detail.html">Property Simplified</a></h5>
									<div class="project-one_designation">Photo Editing</div>
								</div>
		...
		<div class="auto-container">
			<div class="clients-three_inner-container">
				...
				<ul class="sponsors-carousel-two owl-carousel owl-theme">
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="{{asset('')}}frontend/images/clients/15.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="{{asset('')}}frontend/images/clients/16.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="{{asset('')}}frontend/images/clients/17.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="{{asset('')}}frontend/images/clients/18.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="{{asset('')}}frontend/images/clients/15.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="{{asset('')}}frontend/images/clients/16.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="{{asset('')}}frontend/images/clients/17.png" alt=""></a></figure></li>
					<li class="slide-item"><figure class="client-one_image-box-two"><a href="#"><img src="{{asset('')}}frontend/images/clients/18.png" alt=""></a></figure></li>
