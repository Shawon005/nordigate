  ...
  <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Create New Slider Box </h4>
                        <form class="floating-labels m-t-40" action="{{route('admin.slider_box.store')}}" method ="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mt-5 text-right">
                                ...
                                <a href="{{route('admin.slider_box.index')}}"class="btn btn-inverse waves-effect waves-light">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
