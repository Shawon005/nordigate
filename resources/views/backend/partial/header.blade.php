<header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <!-- ============================================================== -->
                <div class="navbar-header" style="background-color: #242a33;">
                    <a class="navbar-brand" href="{{route('admin.dashbord')}}">
                        <b>
                            <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
                            <!-- Dark Logo icon -->
                            <img src="{{asset('')}}frontend/images/original.png" weight="80px" height="80px" alt="homepage" class="dark-logo"  />
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                <h4>User</h4>
                                                <p class="text-muted">User@gmail.com</p><a href="#" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                        </div>
                                    </li>
