  ...
  <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Create New Working Process</h4>
                        <form class="floating-labels m-t-40" action="{{route('admin.process.store')}}" method ="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mt-5 text-right">
                                ...
                                <a href="{{route('admin.process.index')}}"class="btn btn-inverse waves-effect waves-light">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
